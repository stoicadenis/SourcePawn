...
{
    name = "Stergator mesaje inutile din chat 2", 
    author = "Pizant" 
};

public void OnPluginStart()
{
    HookUserMessage(GetUserMessageId("TextMsg"), MsgHook_Messages, true);
}

public Action MsgHook_Messages(UserMsg msg_id, BfRead msg, const players[], playersNum, bool reliable, bool init)
{
    char buffer[64];
